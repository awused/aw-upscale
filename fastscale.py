...
# fastscale.py upscales an image file very quickly with low quality, for testing purposes.
# Installation: You probably shouldn't.
...
# yapf: enable
cp = subprocess.run(args, timeout=timeout, **kwargs)
try:
    cp.check_returncode()
